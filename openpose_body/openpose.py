...
cv2.imshow("Output-Keypoints_2",imageCopy)
cv2.waitKey(0)
cv2.destroyAllWindows()

# x=[]
# y=[]
# for parts,num in BODY_PARTS.items():
#     try:
#         x.append(points[num][0])
#         y.append(points[num][1])
#         print(parts , "=" , points[num] )
